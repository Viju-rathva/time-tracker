      ...
      <footer className="footer_section">
        <div className="footer_container">
          ...
          <div className="social_icons">
            <a href="https://www.instagram.com/viju__rathwa/" target="_blank" rel="noopener noreferrer">
              <i><FaInstagram /></i>
            </a>
            <a href="https://github.com/Viju-rathva" target="_blank" rel="noopener noreferrer">
              <i><FaGithub /></i>
            </a>
            <a href="https://www.linkedin.com/in/viju-rathva-6a08492b6/" target="_blank" rel="noopener noreferrer">
              <i><FaLinkedin /></i>
            </a>
          </div>
        </div>
