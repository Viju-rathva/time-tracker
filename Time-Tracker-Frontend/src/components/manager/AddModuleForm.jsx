...
const AddModuleForm = ({ moduleId, refreshModules }) => {
    ...
    const [moduleData, setModuleData] = useState({
        ...
        statusId: "67ef98f963183b906d218520",
    ...
    const statusOptions = [
        { _id: "67ef98f963183b906d218520", name: "In Progress" },
        { _id: "67ef990963183b906d218522", name: "Completed" },
        { _id: "67ef991b63183b906d218524", name: "Pending" }
    ];
            ...
            axios.get(`http://localhost:3000/project-modules/${moduleId}`)
                .then(response => {
                    ...
                    setModuleData({
                        ...
                        statusId: statusId ? statusId._id : "67ef98f963183b906d218520",
                        projectId: projectId || "",
                    });
                })
