                    ...
                    <div className="card-body">
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-control" id="statusId" {...register('statusId', { required: 'Status is required.' })} style={styles.input}>
                                ...
                                <option value="67ef98f963183b906d218520">In Progress</option>
                                <option value="67ef990963183b906d218522">Completed</option>
                                <option value="67ef991b63183b906d218524">Pending</option>
                            </select>
